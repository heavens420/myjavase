...
//        File file = new File("C:\\Users\\heave\\Desktop\\DeskTop\\fish.jpg");
//        readImageInfo(file);
//        convertGpsToLoaction(30.477963888888887,114.40266944444446);
//        List<User> list = new ArrayList<>();
//        list.add(new User(123, "dfsd"));
//        list.add(new User(333, "pppd"));
//
